...
describe('TerritorialContextPanel', () => {
  ...
  it('mantiene la identidad no determinada cuando sólo hay evidencia documental', () => {
    ...
    expect(screen.getByText('Identidades documentales del instrumento (sin vínculo parcelario acreditado)')).toBeTruthy()
    expect(screen.queryByText(/v&iacute;culo parcelario/i)).toBeNull()
